function Objects = ObjectDetection(Picture, HaarCascade,Options)
...
% The default Options
defaultoptions=struct('ScaleUpdate',1/1.2,'Resize',true,'Verbose',true, 'LimitScale', 0, 'LimitClusters', 100);
...
% Get the integral images (CHECKED)
IntergralImages= GetIntergralImages(Picture,Options);


Objects = HaarCasadeObjectDetection(IntergralImages, HaarCascade,Options);

% Merge multiple detections
% Objects [x y width height]
Objects = postProcessing(Objects);
